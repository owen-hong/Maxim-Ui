            ...
            csslint.verifyFile(content,function(data){
                if(data.status == false){
                    ...
                    .then(function(results){
                        ...
                        //cssom对象
                        var om = cssom.parse(results.css);
                        //分析并处理cssom对象
                                ...
                                if (includes(selector, rules[i].selectorText)) {
                                    ...
                                    if(svgUrl && !Array.isArray(svgUrl)){
                                        if(file.color){
                                            ...
                                            rules[i].style['background-image'] = CurrentUrl;
                                            ...
                                            rules[i].style.length = currentLength;
                                            rules[i].style['background-image'] = svgUrl;
                        ...
                        data.svgSpriteData.forEach(function (svgSpriteData) {
                            ...
                            for (let i = 0; i < len; i++) {
                                if (includes(selector,rules[i].selectorText)) {
                                    ...
                                    rules[i].style['background-image'] = 'url(sprite/' + svgSpriteFile + ');';
